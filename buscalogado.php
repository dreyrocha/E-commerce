...
if (isset($_SESSION['email'])) {
    $mensagemBoasVindas = htmlspecialchars($_SESSION['email']);
} else {
...
<body>
            ...
            <section class="endNav">
                <nav>
                    ...
                    <li class="carrinhoCar">
                            <a href="pages/carrinho_compras.php""><i class=" bi bi-cart" id="cart-icon"></i>Meu carrinho</a>
                    </li>
                    <li>
                        <h1>Você está logado como: <br> 
        ...
        <div class="interface">
            <article class="itens-container">
                <div class="txt-itens">
                    ...
                    <button><a href="pages/carrinho_compras.php"> adicionar ao carrinho<i class=" bi bi-cart"></i></a></button>
    ...
    <section class="vantagens">
        ...
        <section class="vantagens">
            ...
            <a href="./pages/carrinho_compras.php"><button class="maisI"><span>ver mais produtos </span></button></a>
            </div>
        </section>
